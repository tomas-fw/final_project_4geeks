                ...
                <div className="row">
                    <div className="col-md-8 offset-md-2">
                        ...
                        <form onSubmit={e => actions.login(e, props.history, store.role)}>
                            <fieldset className="form-group" /*género*/>
                                <div className="row">
                            ...
                            <input type="text" value={store.trainer_email} className="form-control" />
                            <input type="text" value={store.nutritionist_email} className="form-control" />
                            <input type="text" value={!!store.currentUser && store.currentUser.user.client_id} className="form-control" />
