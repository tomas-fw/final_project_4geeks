            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-8 offset-md-2">
                        ...
                        :
                        <h4>Para crear un plan, pimero tienes que seleccionar tus equipo que te ayudara con tus pautas de dieta y entrenamento, puede hacerlo haciendo click  <Link to='/team'>Aqui</Link> </h4>
